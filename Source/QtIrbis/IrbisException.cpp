...
IrbisException::IrbisException(qint32 c) : code(c) {
}

IrbisException::IrbisException(const QString &message) : message(message) {
}

QString IrbisException::getErrorDescription(qint32 code) {
    QString result = "Неизвестная ошибка";
