...
FileSpecification::FileSpecification(): binaryFile(false), path(), database(), filename(), content() {
}

FileSpecification::FileSpecification(int path, const QString &filename) : binaryFile(false), database(), content() {
    this->path = path;
    this->filename = filename;
}

FileSpecification::FileSpecification(int path, const QString &database, const QString &filename) : binaryFile(false), content() {
    this->path = path;
